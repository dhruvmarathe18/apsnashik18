...
function DailyEntry() {
  ...
  const [dieselInfo, setDieselInfo] = useState(null)
  ...
  useEffect(() => {
    if (formData.Bus) {
      ...
      if (lastEntry) {
        ...
        setFormData(prev => ({
          ...prev,
          'Start KM': lastEndKM > 0 ? lastEndKM : ''
        }))
      } else {
  ...
  useEffect(() => {
    if (formData.Bus && formData.Date) {
      ...
      const dailyKM = parseFloat(formData['Daily KM']) || 0
      const dieselFilled = parseFloat(formData['Diesel Filled']) || 0
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      try {
        ...
        const savedEndKM = parseFloat(entry['End KM'] || 0)
        ...
        setFormData(prev => ({
          ...prev,
          'Driver Name': '',
          'Start KM': savedEndKM > 0 ? savedEndKM : '', // Auto-set to End KM from this entry
          'End KM': '',
          'Daily KM': 0,
          'Diesel Filled': '',
          'Diesel Rate': '',
