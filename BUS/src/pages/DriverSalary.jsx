...
function DriverSalary() {
  ...
  const calculateWorkDays = (driverName) => {
  ...
  // Delete salary
  const handleDeleteSalary = (driverName) => {
    const key = `${driverName}_${selectedMonth}`
                    ...
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        {isEditing ? (
                          ...
                          salary.amount ? `₹${parseFloat(salary.amount).toFixed(2)}` : '-'
                        )}
                      </td>
                      <td className="px-4 py-3 text-right font-semibold">
                        {salary.total ? `₹${parseFloat(salary.total).toFixed(2)}` : '-'}
                      </td>
