...
function transformStudent(dbRow: any): Student {
  return {
    ...
    aadharNumber: dbRow.aadhar_number || undefined,
    ...
    previousSchoolName: dbRow.previous_school_name || undefined,
    bloodGroup: dbRow.blood_group || undefined,
    casteCategory: dbRow.caste_category || undefined,
    casteOther: dbRow.caste_other || undefined,
    birthPlace: dbRow.birth_place || undefined,
    ...
    busRouteAddress: dbRow.bus_route_address || undefined,
    status: dbRow.status,
    createdAt: dbRow.created_at,
...
function transformToDbStudent(student: Student | Partial<Student>): any {
  return {
    ...
    aadhar_number: (student as Student).aadharNumber || null,
    ...
    previous_school_name: (student as Student).previousSchoolName || null,
    blood_group: (student as Student).bloodGroup || null,
    caste_category: (student as Student).casteCategory || null,
    caste_other: (student as Student).casteOther || null,
    birth_place: (student as Student).birthPlace || null,
    ...
    bus_route_address: (student as Student).busRouteAddress || null,
