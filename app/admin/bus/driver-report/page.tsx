              ...
              <div className="bg-gradient-to-r from-primary-500 to-primary-700 text-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white bg-opacity-20 rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold">{formatRupee(reportData.totals.totalDieselAmount)}</div>
                  </div>
                  <div className="bg-white bg-opacity-20 rounded-lg p-4">
                    <div className="text-sm opacity-90">Total Expenses</div>
                    <div className="text-3xl font-bold">{formatRupee(reportData.totals.totalExpense)}</div>
                  </div>
                </div>
              </div>
